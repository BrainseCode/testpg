      ...
      <div className={`${CLASS_NAME}`}>
        <div className={`${CLASS_NAME}__wrapper`}>
          <div className={`${CLASS_NAME}__box`}>
            <img
              src="https://yssystems.com/assets/graphql.png"
              alt="GraphQL API"
            />
          ...
          <div className={`${CLASS_NAME}__box`}>
            <img
              src="https://yssystems.com/assets/react-admin.png"
              alt="React-Admin"
            />
            <h2>Admin UI</h2>
            <div className={`${CLASS_NAME}__box__message`}>
          ...
          <div className={`${CLASS_NAME}__box`}>
            <img
              src="https://yssystems.com/assets/restapi.png"
              alt="REST API"
            />
        ...
        <div className={`${CLASS_NAME}__read-more`}>
          <span>Read </span>
          <a href="https://docs.yssystems.com/api" target="docs">
            YSsystems docs
          </a>
